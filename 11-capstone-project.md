...
``` error
Error:
! object 'basic_features' not found
```
...
``` error
Error in `mutate()`:
ℹ In argument: `phase = case_when(...)`.
Caused by error in `case_when()`:
! Failed to evaluate the left-hand side of formula 1.
Caused by error:
! object 'integrated_intensity' not found
```
...
``` error
Error:
! object 'phase_summary' not found
```
...
``` error
Error:
! object 'cell_cycle_table' not found
```
